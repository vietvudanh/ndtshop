...
# Database: ndtshop
# Generation Time: 2015-07-30 18:27:22 +0000
# ************************************************************
...
CREATE TABLE `Comment` (
  ...
  CONSTRAINT `FK_Product_Comment` FOREIGN KEY (`ProductID`) REFERENCES `Product` (`ProductID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `Customer` (`CustomerID`, `CustomerPassword`, `CustomerUsername`, `CustomerName`, `CustomerDOB`, `CustomerTel`, `CustomerEmail`, `CustomerAddress`, `CustomerCity`, `CustomerCountry`, `CustomerLastestLogin`)
VALUES
	(1,'123456','vietvd','Viet Vu Danh',NULL,NULL,'qwe@qwe1',NULL,NULL,NULL,NULL);
...
INSERT INTO `Products` (`ProductID`, `ProductName`, `ProductDescription`, `ProductImage`, `ProductSalePrice`, `SubCategoryID`)
VALUES
	(1,'R8','Audi R8','None',100000,1),
	(2,'Skyline','Nissan Skyline',NULL,12312300,1);
...
CREATE TABLE `ProductSupplier` (
  ...
  CONSTRAINT `FK_Product_ProductSupplier` FOREIGN KEY (`ProductID`) REFERENCES `Product` (`ProductID`),
...
INSERT INTO `SubCategory` (`SubCategoryID`, `SubCategoryName`, `SubCategoryDescription`, `CategoryID`)
VALUES
	(1,'Sport cars','Sport cars',1),
	(2,'Trucks','Trucks',1),
	(3,'Convertible','Car can remove heads',1),
	(4,'Moutain bikes','Moutain',2);
