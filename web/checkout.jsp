			...
			<div class="in-check" >
				...
				<ul class="cart-header">
					<div class="close1"> </div>
						<li class="ring-in"><a href="detail.jsp" ><img src="images/fcrprofect.png" class="img-responsive" alt=""></a>
						</li>
						<li><span>FCR Profect one plus</span></li>
						<li><span>$ 2900.00</span></li>
						<li><span>In Stock</span></li>
						<li> <a href="account.jsp" class="add-cart cart-check">ADD TO CART</a></li>
					<div class="clearfix"> </div>
				</ul>
				<ul class=" cart-header1">
					<div class="close2"> </div>
						<li class="ring-in"><a href="detail.jsp" ><img src="images/leksellgamma.png" class="img-responsive" alt=""></a>
						</li>
						<li><span>LEKSELL GAMMA KNIFE</span></li>
						<li><span>$ 3000.00</span></li>
						<li><span>In Stock</span></li>
						<li> <a href="account.jsp" class="add-cart cart-check">ADD TO CART</a></li>
						<div class="clearfix"> </div>
				</ul>
				<ul class="cart-header2">
					<div class="close3"> </div>
						<li class="ring-in"><a href="detail.jsp" ><img src="images/airisventoLT.jpg" class="img-responsive" alt=""></a>
						</li>
						<li><span>MRI 0.3T-AIRIS VENTO LT</span></li>
